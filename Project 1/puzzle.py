...
knowledge2 = And(
    # TODO
    # A says "We are the same kind."
    Or( And(AKnight, Or(And(AKnave,BKnave), And(AKnight,BKnight))),
        And(AKnave, Not(Or(And(AKnave,BKnave), And(AKnight,BKnight))))
    ),
    
    # B says "We are of different kinds."
    Or( And(BKnight, Or(And(AKnave,BKnight), And(AKnight,BKnave))),
...
knowledge3 = And(
    ...
    # B says "A said 'I am a knave'."
    Implication(BKnight, Or( And(AKnight,BKnave), And(AKnave, Not(BKnave)))),
    Implication(BKnave, Not(Or( And(AKnight,BKnave), And(AKnave, Not(BKnave))))),
